...
if (myLocation.toLowerCase() === "home"){
    nav.innerHTML = "<ul><li id='navlogoContainer'><img src='./images/logo/Dan_Does_Cocktails_Light_Shadow.jpg' alt='danieldoescocktails' id='navlogo'><img src='./images/buttons/hamburgerButton.png' alt='button' id='hamburgerBtn' onclick='openNav()'/></li><li id='navfirst' class='slide'><a href='#'>Home</a></li><li class='slide'><a href='./html/about.html'>About</a></li><li class='slide'><a href='./html/cabinet.html'>Cabinet</a></li><li class='slide'><a href='./html/resources.html'>Resources</a></li><li id='navlast' class='slide'><a href='./html/blog.html'>Blog</a></li></ul>";
}
else{
    nav.innerHTML = "<ul><li id='navlogoContainer'><img src='../images/logo/Dan_Does_Cocktails_Light_Shadow.jpg' alt='danieldoescocktails' id='navlogo'><img src='../images/buttons/hamburgerButton.png' alt='button' id='hamburgerBtn' onclick='openNav()'/></li><li id='navfirst' class='slide'><a href='../index.html'>Home</a></li><li class='slide'><a href='../html/about.html'>About</a></li><li class='slide'><a href='../html/cabinet.html'>Cabinet</a></li><li class='slide'><a href='../html/resources.html'>Resources</a></li><li id='navlast' class='slide'><a href='../html/blog.html'>Blog</a></li></ul>";
}
